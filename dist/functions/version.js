...
handler = function(msg, match, H) {
  ...
  embed = new Discord.RichEmbed().setColor('#448aff').setTitle(`Haruka ${H.version}`).addField("Uptime", formattedTime(H.client.uptime / 1000)).setFooter(`${H.config.name}@${H.version}`).setTimestamp(H.client.readyAt);
