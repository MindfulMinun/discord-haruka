...
(function() {
  ...
  handler = function(msg, match, H) {
    ...
    if (!q) {
      return msg.reply(["Ask a question, and I’ll reveal the universe’s secrets or something.", "I’m an all-knowing being; I will answer any question using `Math.random()`. Now then, what’s your question?"].choose() + " (Use `-h 8ball <question>`)");
    }
