...
(function() {
  ...
  handler = function(msg, match, Haruka) {
    ...
    if (!((1 <= amount && amount <= 1000))) {
      return msg.reply(["The amount specified must be a positive integer less than 1000.", "The amount of messages to delete must be a number greater than 0 and less than or equal to 1000."].choose());
    }
